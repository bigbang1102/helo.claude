...
name: bud
description: '[standard] v26.5.16 G-SKLL | Create a new oracle via maw bud — yeast-colony reproduction. Use when user says "bud", "new oracle", "create oracle", "spawn oracle", or wants to create a new permanent oracle from the current one.'
